...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pyboy.core.__init__",
        "sources": [
            "pyboy\\core\\__init__.py"
        ]
    },
    "module_name": "pyboy.core.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyboy__core____init__
#define __PYX_HAVE_API__pyboy__core____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "pyboy.core.__init__" */
#if !CYTHON_COMPILING_IN_LIMITED_API
#endif
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "pyboy.core.__init__"
extern int __pyx_module_is_main_pyboy__core____init__;
int __pyx_module_is_main_pyboy__core____init__ = 0;

/* Implementation of "pyboy.core.__init__" */
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_s_mb);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_s_mb);
...
#define __pyx_n_s_mb __pyx_mstate_global->__pyx_n_s_mb
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {0, __pyx_k_mb, sizeof(__pyx_k_mb), 0, 0, 1, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  if (__Pyx_InitString(__pyx_string_tab[1], &__pyx_n_s__2) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[2], &__pyx_n_s_cline_in_traceback) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[3], &__pyx_n_u_core) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  ...
  if (__Pyx_InitString(__pyx_string_tab[6], &__pyx_n_s_mb) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
...
__Pyx_PyMODINIT_FUNC init__init__(void) { initcore(); }
#endif
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_pyboy__core____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib("pyboy", __pyx_n_u_core) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyboy.core")) {
      if (unlikely(PyDict_SetItemString(modules, "pyboy.core", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_n_s_mb);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_mb);
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_, __pyx_t_1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_mb); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_mb, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pyboy/core/__init__.py":1
 * #             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyboy.core.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_COMPILING_IN_LIMITED_API
    Py_CLEAR(__pyx_m);
    #endif
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyboy.core.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
